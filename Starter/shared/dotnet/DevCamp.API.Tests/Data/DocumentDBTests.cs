...
namespace DevCamp.API.Data.Tests
{
    ...
    public class DocumentDBTests
    {
        ...
        public async Task ShouldCreateNewIncidentTest()
        {
            ...
            DocumentDBRepository<Incident>.Initialize(endpointUrl, authorizationKey, databaseId, collectionId);
        ...
        [TestMethod()]
        public void ShouldGetIncidentCountTest()
        {
            DocumentDBRepository<Incident>.Initialize(endpointUrl, authorizationKey, databaseId, collectionId);
        ...
        [TestMethod()]
        public void ShouldGetAllIncidentCountTest()
        {
            DocumentDBRepository<Incident>.Initialize(endpointUrl, authorizationKey, databaseId, collectionId);
